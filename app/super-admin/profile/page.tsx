                    ...
                    {user.role === 'SUPER_ADMIN' ? (
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="glass-card rounded-2xl p-6">
                                ...
                                {/* Assuming 'recentMeetings' state is reused to hold the 'recentActivity' array from API for simplicity, or we map over recentMeetings if it holds the activity*/}
                                {recentMeetings.length === 0 ? (
                                    ...
                                    <div className="space-y-3">
                                        {recentMeetings.map((activity) => (
                                            <div key={activity.id || Math.random()} className="flex items-start gap-3 p-3 rounded-xl hover:bg-slate-50 transition-all border border-transparent hover:border-slate-100">
                                                <div className="w-8 h-8 rounded-full bg-indigo-50 flex items-center justify-center flex-shrink-0 mt-0.5">
                                                    <Building2 className="w-4 h-4 text-indigo-500" />
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-sm font-medium text-slate-800">{activity.description || 'System Event'}</p>
                                                    <p className="text-xs text-slate-400 mt-0.5">
                                                        {formatDateTime(activity.date || new Date().toISOString())}
                                                    </p>
                                                </div>
                                            </div>
                                        ))}
                            ...
                            {/* Quick Admin Links */}
                            <div className="glass-card rounded-2xl p-6 bg-gradient-to-br from-white to-slate-50/50">
                                <h3 className="text-sm font-bold text-muted-foreground uppercase tracking-wider mb-4 flex items-center gap-2">
                                ...
                                <div className="grid grid-cols-2 gap-3 mt-4">
                                    <button
                                        ...
                                        className="p-4 rounded-xl border border-slate-200 bg-white hover:border-indigo-300 hover:shadow-md transition-all text-left group"
                                    >
                                        ...
                                        <p className="text-sm font-semibold text-slate-800">Review Registrations</p>
                                        <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-medium">Pending Requests</p>
                                    </button>

                                    <button
                                        onClick={() => router.push('/super-admin/companies')}
                                        className="p-4 rounded-xl border border-slate-200 bg-white hover:border-emerald-300 hover:shadow-md transition-all text-left group"
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                                            <Building2 className="w-4 h-4" />
                                        </div>
                                        <p className="text-sm font-semibold text-slate-800">Manage Companies</p>
                                        <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-medium">Active Tenants</p>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-medium">Global Accounts</p>
                                    </button>

                                    <button
                                        onClick={() => router.push('/super-admin/audit-logs')}
                                        className="p-4 rounded-xl border border-slate-200 bg-white hover:border-purple-300 hover:shadow-md transition-all text-left group"
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                                            <AlertCircle className="w-4 h-4" />
                                        </div>
                                        <p className="text-sm font-semibold text-slate-800">Audit Logs</p>
                                        <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-wider font-medium">System Activity</p>
                                    </button>
                                </div>
                            </div>
                        </div>
